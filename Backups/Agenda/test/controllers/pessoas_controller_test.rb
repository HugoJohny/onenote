...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post pessoas_url, params: { pessoa: { endereco: @pessoa.endereco, latitude: @pessoa.latitude, longitude: @pessoa.longitude, nome: @pessoa.nome, telefone: @pessoa.telefone } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { endereco: @pessoa.endereco, latitude: @pessoa.latitude, longitude: @pessoa.longitude, nome: @pessoa.nome, telefone: @pessoa.telefone } }
